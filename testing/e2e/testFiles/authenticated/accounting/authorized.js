...
describe( 'Post-login landing view for Accounting users', function() {
    ...
    beforeEach( function() {
        if( !pageLoaded ) {
            console.log( 'Loading the authorized page (for user with Accounting role)' );
    ...
    describe( 'when page loads', function() {
        ...
        it( 'expect the Sales menu item to NOT be displayed', function() {
            expect( authorizedPage.salesMenu.isDisplayed() ).toBeFalsy();
        });

        it( 'expect the Accounting menu item to be displayed', function() {
            expect( authorizedPage.accountingMenu.isDisplayed() ).toBeTruthy();
        });
